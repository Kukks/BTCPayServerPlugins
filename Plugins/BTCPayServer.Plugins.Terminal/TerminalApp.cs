...
public class TerminalApp : AppBaseType
{
    private readonly LinkGenerator _linkGenerator;
    private readonly IOptions<BTCPayServerOptions> _options;
    public const string AppType = "Terminal";
    ...
    public override Task<string> ConfigureLink(AppData app)
    {
        return Task.FromResult(_linkGenerator.GetPathByAction(
            nameof(UITerminalController.UpdateSettings),
            "UITerminal", new { appId = app.Id }, _options.Value.RootPath)!);
    }
    ...
    {
        appData.SetSettings(new TerminalSettings());
        return Task.CompletedTask;
    }

    public override Task<string> ViewLink(AppData app)
    {
        return ConfigureLink(app);
    }
}
